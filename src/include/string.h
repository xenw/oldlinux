...
#else
extern inline int strcmp(const char *ct, const char *cs)
{
	register int __res; /* 返回结果 */
	__asm__(
		"movl %1, %%esi\n\t"	/* 源字符串 */
		"movl %2, %%edi\n\t"	/* 目标字符串 */
		"cld\n"
...
#if 0 /* wangjian <begin> */
/* "dest" may be optimized which will cause error */
...
#else
extern inline void* memset(void * d, char c, size_t n)
{
	__asm__(
		"movl %0, %%edi\n\t"
		"cld\n\t"
